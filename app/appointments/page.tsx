...
export default async function AppointmentsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "cancelled":
        return <Badge variant="outline" className="bg-gray-100 text-gray-800 border-gray-200">ملغي</Badge>
      default:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <Button asChild size="lg" className="bg-gradient-to-r from-primary to-blue-600 hover:from-primary/90 hover:to-blue-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
