          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className={`max-w-4xl mx-auto space-y-8 text-center transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight animate-pop-in">
                احجز موعدك الطبي
                <span className="text-primary block mt-2 bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent animate-slide-in-up">
                  بسهولة وأمان
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up delay-500">
                <Button asChild size="lg" className="text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover-lift">
                  <Link href="/centers">
                    احجز موعدك الآن
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className={`transition-all duration-1000 delay-100 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <Card className="text-center hover:shadow-xl transition-all duration-500 hover:-translate-y-3 border-0 bg-background/80 backdrop-blur-sm rounded-2xl hover-lift hover-glow">
        ...
        <section className="py-20 relative">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className={`bg-background/50 backdrop-blur-sm p-8 rounded-2xl border border-border shadow-sm transition-all duration-1000 delay-100 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} hover-lift hover-scale`}>
              ...
              <div className={`bg-background/50 backdrop-blur-sm p-8 rounded-2xl border border-border shadow-sm transition-all duration-1000 delay-200 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} hover-lift hover-scale`}>
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/10 text-primary mb-6 animate-pop-in">
                  {stats[1].icon}
                </div>
                <div className="space-y-3">
              ...
              <div className={`bg-background/50 backdrop-blur-sm p-8 rounded-2xl border border-border shadow-sm transition-all duration-1000 delay-300 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} hover-lift hover-scale`}>
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/10 text-primary mb-6 animate-pop-in">
                  {stats[2].icon}
                </div>
                <div className="space-y-3">
              ...
              <div className={`bg-background/50 backdrop-blur-sm p-8 rounded-2xl border border-border shadow-sm transition-all duration-1000 delay-400 ${statsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} hover-lift hover-scale`}>
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-primary/10 text-primary mb-6 animate-pop-in">
                  {stats[3].icon}
                </div>
                <div className="space-y-3">
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className={`transition-all duration-1000 delay-100 ${newsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                  <Card className="hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden border-0 bg-background/80 backdrop-blur-sm rounded-2xl hover-lift hover-tilt">
                    {/* News Image Preview */}
              ...
              <div className={`text-center mt-12 transition-all duration-1000 delay-300 ${newsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <Button asChild variant="outline" size="lg" className="rounded-full px-8 hover:shadow-lg transition-all hover-lift">
        ...
        <section className="py-20 bg-gradient-to-r from-primary to-blue-700 text-primary-foreground relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className={`max-w-3xl mx-auto space-y-8 text-center transition-all duration-1000 ${ctaVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up delay-500">
                <Button asChild size="lg" variant="secondary" className="text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover-lift">
