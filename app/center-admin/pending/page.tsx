...
export default async function CenterAdminPendingAppointments() {
  ...
  // First, get pending appointments for this center
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-2xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold mb-2">المواعيد المعلقة</h1>
            <p className="text-yellow-100">المواعيد التي تحتاج إلى مراجعة وموافقة</p>
          </div>
      ...
      <div className="grid gap-6">
        {enrichedAppointments && enrichedAppointments.length > 0 ? (
          enrichedAppointments.map((appointment: any) => (
            <Card
              key={appointment.id}
              className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-l-yellow-500"
            >
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">لا توجد مواعيد معلقة</h3>
              <p className="text-gray-600">جميع المواعيد تم مراجعتها</p>
            </CardContent>
          </Card>
        )}
      </div>
