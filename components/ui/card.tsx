...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border border-border/80 shadow-sm transition-all duration-500 hover:shadow-lg medical-card',
        className,
      )}
      {...props}
    />
