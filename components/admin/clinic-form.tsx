...
export function ClinicForm({ initialData, redirectPath }: ClinicFormProps) {
  ...
  // If initialData has a medical_center_id and redirectPath is for center admin, 
  // restrict the medical center selection
  const isCenterAdminForm = redirectPath === "/center-admin/clinics"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use provided redirect path or default to admin
      const finalRedirectPath = redirectPath || "/admin/clinics"
